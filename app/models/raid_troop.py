...
class RaidTroop(Base):
    __tablename__ = "raid_troops"
    __table_args__ = (
        UniqueConstraint("raid_id", "troop_type_id", name="uq_raid_troop_type"),
    )
    ...
    count_sent: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
